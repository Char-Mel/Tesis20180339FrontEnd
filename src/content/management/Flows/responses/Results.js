        ...
        {paginatedUsers.length === 0 ? (
          <>
            <Typography
              ...
              align="center"
            >
              {t('No se ha respondido el formulario aún')}
            </Typography>
          </>
        ) : (
          <>
              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell>Enviado en</TableCell>
                      ...
                      <TableRow hover key={index}>
                        <TableCell>
                          <Box display="flex" alignItems="center">
                            <Box>
                              <Typography>{user.userId.nombre} {user.userId.apellidoPaterno} </Typography>
                            </Box>
                          </Box>
                        </TableCell>
                        <TableCell>
                        ...
                        <TableCell align="center">
                          <Typography>{user.revisado === false? 'Por revisar':'Revisado' }</Typography>
                        </TableCell>
                        <TableCell align="center">
                          <Typography noWrap>
