              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell align="center">
                      Respuestas pendientes a revisar
                    </TableCell>
                  ...
                  {paginatedUsers.map((user, index) => {
                    return (
                      <TableRow hover key={index}>
                        ...
                        <TableCell align="center">
                          <Typography>{user.formulariosEnviados}</Typography>
                        </TableCell>
                        <TableCell align="center">
                          <Typography>{user.formulariosPendientes}</Typography>
                        </TableCell>
                        <TableCell align="center">
                          <Typography noWrap>
                            <Tooltip title="Ver" arrow>
                              <IconButton
                                ...
                                to={
                                  ...
                                  }/management/flows/responses/` + user._id
                                }
                                color="primary"
                              >
