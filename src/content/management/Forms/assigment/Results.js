              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell>Completar desde</TableCell>
                    <TableCell>Completar hasta</TableCell>
                  ...
                  {paginatedUsers.map((user, index) => {
                    return (
                      <TableRow hover key={index}>
                        ...
                        <TableCell>
                          <Typography>{user.limiteInferior  ?  componentDidMount(user.limiteInferior) : 'Sin límite' }</Typography>
                        </TableCell>
                        <TableCell >
                          <Typography>{user.limiteSuperior  ?  componentDidMount(user.limiteSuperior) : 'Sin límite'}</Typography>
                        </TableCell>
