          ...
          <Box sx={{ mt: 0, width: 300 }}>
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <DemoContainer components={['DateTimePicker']}>
                <DateTimePicker
                value={''}
                  format={`${newElement.dateFormat} ${newElement.hourFormat} A`}
                  sx={{ width: 300 }}
                  renderInput={(params) => (
          ...
          <Grid container spacing={2}>
            ...
            >
              <Box
                ...
                alignSelf="center"
              >
                <b>Caracter de seperacion Fecha</b>
              </Box>
            </Grid>
            ...
            <Grid item xs={12} sm={8} md={9}>
              <Autocomplete
                disablePortal
                value={newElement.caracterDate ? newElement.caracterDate : '/'}
                options={[
                  { label: '/', value: '/' },
                  { label: '.', value: '.' },
                  { label: '-', value: '-' }
                ...
                onChange={(event, newValue) => {
                  setNewElement((oldElement) => ({
                    ...oldElement,
                    dateFormat: updateFormatDate(newElement.dateFormat, newElement.caracterDate, newValue.value),
                    caracterDate: newValue ? newValue.value : '/',
                  }));
            ...
            <Grid item xs={12} sm={8} md={9}>
              <Autocomplete
                ...
                onChange={(event, newValue) => {
                  setNewElement((oldElement) => ({
                    ...oldElement,
                    dateFormat: getFormatDate(newValue.value, newElement.caracterDate ? newElement.caracterDate : '/'),
            ...
            <Grid item xs={12} sm={8} md={9}>
              <Autocomplete
                disablePortal
                value={newElement.caracterHour ? newElement.caracterHour : ':'}
                options={[
                  { label: ':', value: ':' },
                  { label: '.', value: '.' }
                ]
                ...
                onChange={(event, newValue) => {
                  setNewElement((oldElement) => ({
                    ...oldElement,
                    hourFormat: updateFormatHour(newElement.hourFormat, newElement.caracterHour, newValue.value),
                    caracterHour: newValue ? newValue.value : ':',
            ...
            <Grid item xs={12} sm={8} md={9}>
              <Autocomplete
                ...
                onChange={(event, newValue) => {
                  setNewElement((oldElement) => ({
                    ...oldElement,
                    hourFormat: getFormatHour(newValue.value, newElement.caracterHour ? newElement.caracterHour : '/'),
