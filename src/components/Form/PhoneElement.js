...
const PhoneElement = ({ element, index, updateElement }) => {
        ...
        <Box sx={{ fontSize: '16px', fontWeight: '500' }}>
          ...
          <Box sx={{ mt: 1, width: 300 }}>
            <MuiTelInput
              ...
              defaultCountry={element.codPais}
              ...
              <MuiTelInput     
                ...
                onChange={(value,info) => {
                  setNewElement((oldElement) => ({
                    ...oldElement,
                    numPais: value,
                    codPais: info.countryCode
                  }));
                  
                }}
                value={newElement.numPais}
                variant="outlined"
                size="small"
                langOfCountryName="es"
                continents={['SA']}
                inputProps={{
                  readOnly: true // Deshabilitar la escritura
                }}
              />
            </Grid>
